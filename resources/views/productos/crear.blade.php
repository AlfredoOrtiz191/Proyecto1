...
<div class="row mt-3 ">
    ...
    <form method="post" action="{{URL('/productos/save')}}">
        {{csrf_field()}}
        <label>Nombre</label>
        <input type="text" class="form-control" name="name" placeholder="Indique el nombre porfavor">
        <label>Categoria</label>
        <input type="text" class="form-control" name="categoria" placeholder="Indique la categoria porfavor">
        <label>Descripcion</label>
        <input type="text" class="form-control" name="descripcion" placeholder="Indique la descripcion del producto">
        <label>Precio</label>
        <input type="number" class="form-control" name="precio" placeholder="Indique su precio porfavor">
        <label>Stock</label>
        <input type="number" class="form-control" name="stock" placeholder="Indique la cantidad porfavor">
        <label>Foto</label><br>
